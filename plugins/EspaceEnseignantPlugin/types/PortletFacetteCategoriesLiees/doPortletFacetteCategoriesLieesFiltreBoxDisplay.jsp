...
<% 
	...
	String listeNoire = channel.getProperty("jcmsplugin.espaceEnseignant.portlet.categorieslies.listenoire");
%>
			...
			<div class="ds44-listSelect">
				<ul class="ds44-list" role="listbox" id='<%= "listbox-" + idFormElement %>' 
					...
					<jalios:foreach name="itRootCat" type="Category" collection='<%= obj.getCategoriePrincipales(loggedMember) %>'>
						...
						<jalios:if predicate="<%= Util.isEmpty(listeNoire) || !listeNoire.contains(itCat.getId()) %>">
