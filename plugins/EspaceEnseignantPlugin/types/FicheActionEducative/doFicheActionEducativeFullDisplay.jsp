...
<%--    TODO    
 ...
 --%>      <% } %>
      ...
      <%
         ...
         pubRelatedCollection =  Util.getArrayList(relatedContents);
         QueryHandler qh = new QueryHandler();  
         qh.setTypes(new String[] {"generated.FicheActionEducative"});  
         qh.setSort("pdate");
         pubRelatedCollection = (SortedSet<Publication>)QueryManager.getInstance().getRelatedPublicationSet(obj, qh);
         %>
